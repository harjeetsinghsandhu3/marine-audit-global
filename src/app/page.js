...
import { Mail, Phone, MessageCircle, Globe, Clock, MapPin, ShieldCheck, ClipboardCheck, Ship, FileSearch, GraduationCap, SearchCheck, BriefcaseBusiness, Building2, Cog, Anchor, Menu, X,} from "lucide-react";
...
const organizationSchema = {
  ...
  logo: "https://www.marineauditglobal.com/logo-transparent.png",
...
const jsonLd = {
  ...
  image: "https://www.marineauditglobal.com/logo-transparent.png",
...
/>
  ...
  <div className="relative max-w-7xl mx-auto px-4 md:px-6 py-3 md:py-5 flex items-center justify-between">
    ...
    <div className="flex items-center gap-3 md:gap-6">
      ...
      <Image
        ...
        height={110}
        priority
        className="w-[70px] h-[70px] md:w-[100px] md:h-[100px] object-contain shrink-0 select-none pointer-events-none"      />

      <div>
        <h1 className="font-bold tracking-widest text-sm md:text-xl leading-tight">
          MARINE AUDIT GLOBAL
        </h1>

        <p className="hidden md:block text-[10px] text-slate-400 tracking-[0.2em]">
    ...
    <nav className="hidden md:flex gap-8 text-sm font-semibold tracking-wide">
      ...
      <a href="#clients" className="hover:text-[#D4AF37] transition">CLIENTS</a>
    ...
    <a
      href="#request"
      className="hidden md:inline-flex bg-blue-600 hover:bg-blue-700 text-white font-bold px-10 py-4 rounded-xl shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300"
    >
  ...
  className="md:hidden text-white z-[9999] relative p-2"
>
  ...
  {mobileMenuOpen && (
   ...
   <div className="md:hidden absolute left-0 top-full w-full bg-[#081120] border-t border-slate-800 z-[9998] shadow-2xl">

      <nav className="flex flex-col text-center py-6 space-y-5 font-semibold">
        ...
        <a
          ...
          className="mx-6 mt-3 bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 rounded-xl"
        >
          REQUEST AN INSPECTION
        </a>
...
<div className="rounded-3xl relative h-[380px] md:h-[690px] w-full">
...
<div className="max-w-7xl mx-auto px-6">
  ...
  <div className="grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative h-[380px] md:h-[620px] w-full rounded-3xl">
  ...
  quality={100}
  unoptimized
   className="rounded-3xl shadow-2xl w-full h-[380px] md:h-[620px] object-cover object-[45%_center] md:object-[45%_center]"
  />
</div>
...
confidentiality and integrity.
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
              ...
              <div className="bg-[#0B1B32] border border-slate-700 rounded-2xl p-6">
               <h3 className="text-2xl md:text-3xl font-black text-[#D4AF37] leading-tight break-words">
Independent
</h3>
...
<div className="grid lg:grid-cols-2 gap-16 items-start"></div>
          <div>
            ...
            <h2 className="text-3xl md:text-5xl font-black uppercase leading-[1.05] text-center">
...
>
  ...
  className="mag-textarea w-full rounded-xl px-5 py-4 resize-none overflow-y-auto outline-none"
  onInput={handleFilled}
></textarea>
...
<span className="text-[#D4AF37]">
  ...
  <p className="text-slate-300 text-sm flex flex-wrap justify-center md:justify-start items-center gap-2">
