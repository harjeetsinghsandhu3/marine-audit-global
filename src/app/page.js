...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white font-sans text-slate-900 scroll-smooth">
      ...
      <nav className="flex items-center justify-between px-6 lg:px-20 py-5 bg-white/90 backdrop-blur-md sticky top-0 z-50 border-b border-slate-100">
        ...
        <div className="hidden lg:flex gap-10 items-center">
          ...
          <a href="#audit-form" className="bg-[#D4AF37] hover:bg-[#0D1B2A] text-white px-6 py-2.5 rounded-sm font-bold text-[10px] uppercase tracking-widest transition-all">
            Request Audit
          </a>
        </div>
      ...
      <main>
        ...
        {/* TECHNICAL COMPETENCIES - Interactive Cards */}
        ...
        {/* AUDIT FORM - Grid Refinement */}
        <section id="audit-form" className="py-24 bg-white px-6">
          <div className="max-w-5xl mx-auto bg-[#0D1B2A] flex flex-col lg:flex-row shadow-2xl overflow-hidden">
            {/* Info Side */}
...
function ServiceCard({ title, desc, icon }) {
  return (
    <div className="group p-10 bg-white border border-slate-100 text-left hover:-translate-y-2 hover:shadow-2xl transition-all duration-300">
