...
{/* SERVICES SECTION */}
  ...
  Independent onboard audits to verify compliance with ISM, ISPS and
  MLC requirements. We help ship owners and managers improve safety,
  regulatory compliance and operational performance through practical,
  experience-based auditing.
</p>
            </div>
            ...
            <div className="bg-[#0B1B32] border border-slate-700 rounded-3xl p-8 hover:border-[#D4AF37] transition">
              ...
              <h3 className="text-2xl font-bold mb-4">
                Marine Operational Audits & Inspections
              </h3>

              <p className="text-slate-400 leading-7">
  Independent Sailing and staticnavigation, Sailing engine room, cargo handling, mooring & Anchoring, bunker and environmental audits conducted to identify operational risks, verify best practices and improve vessel safety, efficiency and regulatory compliance. 
</p>
            </div>
            ...
            <div className="bg-[#0B1B32] border border-slate-700 rounded-3xl p-8 hover:border-[#D4AF37] transition">
              ...
              <h3 className="text-2xl font-bold mb-4">
                Marine Consultancy & Investigation
              </h3>

              <p className="text-slate-400 leading-7">
  Professional consultancy for SIRE 2.0 & CDI preparation, TMSA Audits, RightShip inspection preparation, PSC (USCG, AMSA, CHINA) preparation, independent pre-purchase vessel inspections, accident and incident investigations and reporting, SMS implementation, onboard training and technical assistance for continuous operational improvement as per marine industry standards.
</p>
            </div>
