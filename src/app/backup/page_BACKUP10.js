...
import { Mail, Phone, MessageCircle, Globe, Clock, MapPin } from "lucide-react";
...
></textarea>
  ...
  <button
    type="submit"
   className="w-full bg-[#2563EB] hover:bg-[#1D4ED8] text-white font-bold text-lg py-5 rounded-xl transition duration-300 shadow-lg"
  >
    REQUEST AN INSPECTION
  </button>
