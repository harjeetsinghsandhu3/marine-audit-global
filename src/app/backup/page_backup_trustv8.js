...
<div className="grid lg:grid-cols-2 gap-16 items-start"></div>
  ...
  REQUEST <span className="text-[#D4AF37]">A MARINE INSPECTION</span>
</h2>
...
>
  ...
  MARINE AUDIT GLOBAL
              ...
              <p className="text-slate-400 leading-7 max-w-[320px]">
  ...
  <span>info@marineauditglobal.com</span>
</li>

    <li className="flex items-center gap-3">
  <Phone size={18} className="text-[#D4AF37]" />
  <span>+91 7589228802</span>
</li>
  ...
  <span>Worldwide Marine Support</span>
</li>
  ...
  <span>24/7 Emergency Response</span>
         ...
         <div className="border-t border-slate-800 mt-08 pt-5 flex flex-col md:flex-row justify-between items-center gap-4">
