...
operational lifecycle.
  ...
  <ul className="space-y-3 text-slate-400 leading-7 list-disc list-inside text-left">
    ...
    <li>Safe, efficient & compliant vessel operations</li>
